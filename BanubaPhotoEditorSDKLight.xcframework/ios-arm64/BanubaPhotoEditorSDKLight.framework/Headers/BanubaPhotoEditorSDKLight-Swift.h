...
#ifndef BANUBAPHOTOEDITORSDKLIGHT_SWIFT_H
#define BANUBAPHOTOEDITORSDKLIGHT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BanubaPhotoEditorSDKLight",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC25BanubaPhotoEditorSDKLight30AlbumPreviewCollectionViewCell")
@interface AlbumPreviewCollectionViewCell : UICollectionViewCell
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC25BanubaPhotoEditorSDKLight17BanubaPhotoEditor")
...
SWIFT_PROTOCOL("_TtP25BanubaPhotoEditorSDKLight25BanubaPhotoEditorDelegate_")
@protocol BanubaPhotoEditorDelegate
